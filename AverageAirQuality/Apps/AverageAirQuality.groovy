definition(
    ...
    importUrl: 'https://raw.githubusercontent.com/vinnyw/hubitat/master/AverageAirQuality/Apps/AverageAirQuality.groovy',
    ...
    dynamicPage(name: 'mainPage', install: true, uninstall: true) {
        section() {
            app(
                ...
                name: 'childApps',
                appName: "AirQuality-${getShortVersion()}",
                namespace: 'vinnyw',
                multiple: true
            )
        }
...
private void enforceLabel() {
    String defaultName = 'Average Air Quality'
