definition(
    ...
    description: 'Manage multiple time based virtual batteries',
    category: 'Convenience',
    importUrl: 'https://raw.githubusercontent.com/vinnyw/hubitat/master/VirtualBattery/Apps/VirtualBattery.groovy',
...
private void enforceLabel() {
    String defaultName = 'Virtual Battery'
